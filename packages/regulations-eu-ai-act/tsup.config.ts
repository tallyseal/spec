...
/**
 * EU AI Act pack emits two entries:
 * - `index.ts` — Contract factories (runtime intent-evaluation surface)
 * - `disclosure-templates/index.ts` — Art. 50 disclosure-boilerplate
 *   filler per HF feedback 2026-06-02 item 4. Separate entry so the
